...
- **74 の指導法** を効果量(+◯ヶ月)・エビデンス強度(★)・コスト(¥)で一覧化
...
| テスト | [Playwright](https://playwright.dev/) (E2E 65 テスト) |
| リンター | textlint (日本語校正) |
...
Node.js のバージョンは `.tool-versions` で固定(`nodejs 24.19.0`)。[mise](https://mise.jdx.dev/) を推奨。
