...
- **critical**: Rule 1.1 違反(数値と原典の乖離、前提未検証)、未読書籍の main 参考資料掲載、重大事件被害者特定につながる情報、**観点 11 の P1 / P2**(読者リテラシー、スクリプト error)
- **warn**: Rule 1.8 / 1.2a / 1.6 の残留、参考資料 URL の 404、数値密度過多、**観点 11 の P3 + agent 拡張領域**(過密度・括弧説明の質・隣接行をまたぐ初出)
- **info**: 読みやすさ・文体の改善提案、カタカナ専門用語の平易化、**観点 11 の ALLOWED 略語の文脈補足提案**
