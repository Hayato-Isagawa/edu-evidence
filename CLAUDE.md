...
npm run test:e2e           # Playwright E2Eテスト(60テスト・11ファイル=`playwright test --list` の数、ビルド後に実行)
...
**下限の決め方は口ごとに違う。** `test:workflows` の 80 と `test:scripts` の 54 は実測ちょうど
