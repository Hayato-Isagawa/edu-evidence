...
SEL は「自己理解・自己管理・他者理解・対人スキル・意思決定」の 5 領域を育てる学習。行動介入は「望ましい行動を増やし、妨げる行動を減らす」指導アプローチで、EEF の知見では、特定の行動課題のある児童に的を絞った介入(Tier 2/3)で効果が大きいとされています。
...
毎日のようにトラブルを起こす児童には、学級全体への働きかけに加えて、その子に的を絞った個別の支援が必要です。「その子が何に困っているか」(勝ちたい・認められたい・睡眠不足・家庭でのデバイス利用が制御できない、など)を見取り、保護者と共有します。特定の行動課題のある児童に的を絞った介入(Tier 2/3)で効果が大きい、という EEF の知見と合致します。
