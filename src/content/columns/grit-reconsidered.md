...
summary: 一時期もてはやされた「やり抜く力」は、2017 年以降のメタ分析で効果が限定的(r ≈ 0.18)で、しかも既存の性格特性「誠実性」とほぼ重なる(ρ ≈ 0.84)ことが示された。教育現場での扱い方を、エビデンスを踏まえて整理する。
date: "2026-04-12"
...
- [Credé, Tynan & Harms (2017)](https://doi.org/10.1037/pspp0000102) の **88 研究・66,807 人** を対象としたメタ分析は、グリットと学業成績の相関を **r ≈ 0.18**(比較的弱い)と算出しました。さらに、**グリットは既存の性格特性「誠実性(Conscientiousness)」とほぼ同じものを測っている可能性が高い**(両者の相関 ρ ≈ 0.84)と指摘しています
...
- グリットと学業成績の相関は **r ≈ 0.18**(Credé ら 2017 メタ分析、88 研究・66,807 人)で、強い関連ではない
- グリットは **誠実性(Conscientiousness)とほぼ同じもの**(ρ ≈ 0.84)を測っている可能性が高く、新しい構成概念として独自の予測力は小さい
