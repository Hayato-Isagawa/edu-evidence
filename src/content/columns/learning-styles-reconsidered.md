...
[Pashler, McDaniel, Rohrer & Bjork (2008)](https://doi.org/10.1111/j.1539-6053.2009.01038.x) は、学習スタイル理論を支持するエビデンスを系統的にレビューしました。掲載誌は米国心理学会(APS)系列の専門誌 *Psychological Science in the Public Interest* 9(3) です。
...
[Howard-Jones (2014)](https://doi.org/10.1038/nrn3817) は *Nature Reviews Neuroscience* で、教育界に流通する科学的に誤った言説(神経神話)を体系的に整理しました。その中で **学習スタイル / VARK を最も拡散している神経神話** として位置づけています。
...
「直感に合う」「個性尊重と響く」「指導の共通言語になる」概念は、教育の現場に広まりやすいものです。学習スタイル理論はその典型例です。

直感が当てになるとは限らない —— その事実を引き受けるのは難しいことです。しかし子どもの限られた学習時間を最大化するのは、**エビデンスに基づいた具体的な指導の質** です。

## 本シリーズの位置づけ

本コラムは「定説再検証シリーズ」の 1 本です。シリーズの他のコラムでは、[宿題は本当に学力を上げるのか？](/columns/homework-quantity-myth) で宿題の「量」信仰を、[「グリット」は本当に大事なのか?](/columns/grit-reconsidered) で心理学発の概念がメタ分析でどう再評価されたかを扱っています。
