...
しかし、**相関は因果を意味しません**。次のような逆因果・交絡因子の可能性があります。

- 学力が高い子が読書を好む(逆因果)
- 家庭の読書環境(蔵書数・親の読書習慣)が両方に影響(交絡)
- 子どもの語彙力が両方に影響(交絡)

**因果を確定するには RCT(ランダム化比較試験)が必要** ですが、読書介入の RCT は世界的にも多くありません。
...
エビデンスに照らすと、**量より環境・質・継続**に注力する方が筋が通ります。
...
- 読書と学力の **相関** は複数で確認されるが、**因果は限定的**
- フィリピン RCT(2014)は +0.13 SD(小)、3 か月後に半減。**読む機会を増やすと読解がわずかに上がる**、だが他教科には波及しない
- 朝読書の「+2ヶ月」は相関研究からの推定値。**因果の確定値ではない**
- 冊数目標の落とし穴: 薄い本・集計負担・外発的動機づけ
- エビデンスが支持するのは **読書時間の確保・本へのアクセス・読解戦略の指導・ジャンルの多様性**

冊数信仰は、真面目な教員ほど陥りやすい罠です。**「何冊読んだか」より「読み続けられる環境を作れたか」** の方が、エビデンスと整合します。
