...
summary: Barcaui(2025)の RCT は、学部生 120 名を対象に「ChatGPT を使って学習 vs 従来学習」を比較。45 日後の抜き打ちテストで ChatGPT 利用群は 11 ポイント低かった(57.5% vs 68.5%, d=0.68)。学習時間が短くても効果は残る。「思い出す努力」を AI が奪うとき、何が失われるのか。
date: "2026-04-18"
...
ChatGPT が **学びから困難を取り除いてしまい**、結果として保持が弱くなった、という読み方です。
...
- Barcaui, A. (2025). [ChatGPT as a cognitive crutch: Evidence from a randomized controlled trial on knowledge retention](https://www.sciencedirect.com/science/article/pii/S2590291125010186). *Social Sciences & Humanities Open*, 12, 102287. — 学部生 120 名の RCT。ChatGPT 利用群は 45 日後の保持テストで 11 ポイント低く (57.5% vs 68.5%、d=0.68)、学習時間を共変量とした ANCOVA でも効果が残る。
