...
教師期待効果の議論は、教師個人の内面に焦点を当てがちです。しかし Rist 1970 以降の系譜が示したのは、ラベリングは個人の問題ではなく **学級・学校としての対応の問題** でもある、ということです。個別関係でできることと、組織として避けるべきことは別の問題として切り分けます。前者には声かけ・フィードバック・関係性の質といった戦略があります(本サイトの [教師と子どもの関係づくり](/strategies/teacher-student-relationships) や [フィードバック](/strategies/feedback) を参照)。後者には早期トラッキングや固定的なグループ分けの回避が含まれます。
