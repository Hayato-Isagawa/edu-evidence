...
- EEF の Dialogic Teaching RCT(Year 5〔9〜10 歳〕・76 校を割り付け)は **英語・理科で +2 ヶ月、算数で +1 ヶ月、FSM(Free School Meals)児童には 3 科目すべてで +2 ヶ月** と報告(FSM 児童の結果は人数が少なく確実性が低い)。全体では統計的に有意だったのは理科のみで、翌年の全国テスト(KS2)の追跡では効果が確認されなかった
