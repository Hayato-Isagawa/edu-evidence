...
構成概念妥当性が確立していないことは、多重知能理論のすべてを無価値にするわけではありません。
...
この **問題提起の価値** と、**「8つの独立した知能が実在する」という実証的な主張** は、別の軸です。前者は支持できます。子どもを点数で序列化しないという姿勢は、エビデンスの有無と関係なく大切です。しかし後者 —— 独立した知能の分類が科学的に確かめられているか —— については、これまで見たとおり裏づけが乏しい。両者を切り離して受け止めることが、誠実な向き合い方だと言えます。
...
エビデンスが指し示すのは、一人ひとりに複数の入り口を開いておくことです。「この子は何型か」を当てにいく手前で、立ち止まる価値があります。

## 本シリーズの位置づけ

本コラムは「定説再検証シリーズ」の1本です。最も近いのは[「学習スタイル」は本当に効果があるのか?](/columns/learning-styles-reconsidered)(感覚の好みで子どもをタイプ分けする発想)で、[教師の期待とラベルは子どもの未来を決めるか](/columns/pygmalion-and-labeling-reconsidered)(ラベルが子どもに及ぼす力)、[「グリット」は本当に大事なのか?](/columns/grit-reconsidered)(心理学発の概念のメタ分析による再評価)とも地続きです。
