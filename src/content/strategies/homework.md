---
title: 宿題(小学校)
summary: 小学校段階での宿題の効果は中高より小さい(EEF で +3ヶ月、中高は +5ヶ月。エビデンスの強さは低い)。日本は既に家庭学習時間が多いため、量より質と目的の明確さが鍵。
monthsGained: 3
evidenceStrength: 2
cost: 1
subjects: ["全教科"]
...
evidence:
  eef:
    monthsGained: 3
    strength: 1
    note: "小学校段階は +3ヶ月、中学校以上は +5ヶ月。ストランド全体のエビデンスは EEF 自身が 'low'(錠前 1、43 研究)と評価しており、無作為化比較試験でない研究と独立評価を経ていない研究が多いことを減点理由に挙げている。量よりも授業との連動と短く集中した課題が効果的。"
  japan:
    monthsGained: 1
    strength: 2
...
methodology:
  ...
  limitations: "操作研究は 5 件と少なく、うち無作為割付は 3 件のみ。著者ら自身が全研究に設計上の欠陥があると明記している。相関は因果を示さず、対象は米国の研究に限られる。小学校段階では相関がほぼゼロで、EEF も小学校の宿題を +3 か月・エビデンス強度 low と控えめに評価しており、効果は量より質と授業との連動に依存する。"
culturalContext: |
  日本の小学生の家庭学習時間は、国際比較で既に長い水準にある。EEF の +3ヶ月(小学校)をそのまま適用すると過大評価になりやすい。研究は「量を増やす」ことより「授業との連動」「質の高いフィードバック」「取り組みやすい設計」を強調している。中室牧子氏の『「学力」の経済学』でも、宿題量と学力の単純な関係は日本では小さいことが示唆されている。
---
...
- 小学校段階では、平均して学習が約3ヶ月分前進します(中学・高校の +5ヶ月より小さい)。
...
- **学校**: 授業と連動した目的の明確な宿題設計、取り組んだ過程に対する翌日の授業内での接続、家で取り組めなかった子への授業内補充ルートの準備。授業の定着に必要な最小限の量を出発点に。
