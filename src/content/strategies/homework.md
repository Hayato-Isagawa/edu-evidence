...
宿題は構造的に「家庭での時間・環境・サポート」に効果が左右されるため、学校の設計だけでは完結しません。それぞれが担える領域を分担することが前提になります。
...
**「宿題=家庭の責任」というフレームに立つと、家庭環境で取り組めない子の学力低下を学校側が不可視化する危険** があります。家庭の事情を前提に、学校と制度の側で何をどこまで補えるかを設計する視点が要ります。
