...
evidence:
  ...
  hattie:
    cohensD: 0.10
    note: "Adolphus et al.(2016)の系統的レビューでは、朝食摂取が認知に与える効果は短期的・領域特異的(注意・実行機能・記憶)で、**栄養状態が悪い子どもでより明確**に現れると報告。十分に栄養が取れている子どもでは効果が検出されにくく、慢性的な学校朝食プログラムの効果は研究数が少なく結論が出ていない。"
lastVerified: "2026-06-15"
methodology:
  sampleSize: "Adolphus et al.(2016, Advances in Nutrition)は、朝食が子ども・青年の認知に与える効果を介入研究 45 件(43 論文)で系統的にレビュー。先行する Hoyland et al.(2009, Nutrition Research Reviews)は介入研究 45 件(41 論文、1950〜2008 年)を対象とした"
  limitations: "朝食摂取と学力の因果を分離するのは方法論的に困難で、相関には SES などの交絡が混じる。効果は栄養状態が悪い子どもでより明確に現れ、すでに十分に食べている子どもでは検出されにくい。急性効果は注意・実行機能・記憶など領域特異的かつ短期的で、慢性的な学校朝食プログラムの学力効果は研究数が少なく結果も一貫しないため確かな結論は出せない。青年を対象にした研究が少なく、サンプルも小さい点も限界として指摘されている。"
culturalContext: |
...
- **学校**: 朝食欠食を「学力低下の原因」と単純に捉えず、**家庭の生活に余裕がないサイン** として受け止める。給食をセーフティネットとして確実に運用し、欠食が続く子には養護教諭・SC/SSW と連携して背景を確認する。
...
「朝食を食べる→学力が上がる」という因果効果を分離するのは方法論的に困難です。Adolphus et al.(2016)のシステマティックレビューでは、朝食が認知に与える効果は短期的・領域特異的(注意・実行機能・記憶)で、栄養状態が悪い子どもでより明確に現れる一方、十分に栄養が取れている子どもでは検出されにくいとされており、明確な学力月数換算は示されていません。本サイトの「+1ヶ月」は控えめな暫定値で、確定的な効果量ではありません。
