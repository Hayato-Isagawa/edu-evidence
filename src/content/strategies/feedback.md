...
evidence:
  eef:
    monthsGained: 6
    strength: 4
    note: "EEF Toolkit で +6ヶ月。確実性評価は 5 段階中 4(high)で、ランダム化比較試験でない研究の割合が高いため 1 段階下がっている(155 研究)。小学校 +7ヶ月、中学校 +5ヶ月。算数・理科で効果がやや大きい。『課題や学び方へのフィードバック』が『個人や称賛へのフィードバック』より効果的。"
