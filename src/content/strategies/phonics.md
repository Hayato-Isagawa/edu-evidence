...
evidence:
  eef:
    monthsGained: 5
    strength: 4
    note: "EEF Toolkit で +5ヶ月(228 研究)。確実性評価は 5 段階中 4(high)で、独立評価でない研究の割合が高いため 1 段階下がっている。研究の大半は小学校で行われ、中等教育段階を対象にした少数の研究でも平均は同程度(+5ヶ月)。Ehri et al.(2001)のメタ分析(38 研究から導いた 66 の比較)では全体の効果量 d=0.41 で、幼稚園・1 年生で始めた場合(d=0.55)は 2〜6 年生(d=0.27)より大きい。アルファベット表記言語での強力なエビデンス。"
