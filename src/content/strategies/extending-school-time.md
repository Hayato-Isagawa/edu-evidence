---
title: 放課後学習・学習時間の延長
summary: 放課後補習や長期休暇中の学習など、授業時間外の学習機会を増やす取り組み。効果はあるがコストとのバランスが課題。
monthsGained: 3
evidenceStrength: 3
cost: 3
subjects: ["全教科"]
...
学習時間が増えれば、練習や復習の機会が増えます。特に授業内でつまずいた内容を補充する時間として使われた場合に効果が出ます。ただし、単に時間を延ばすだけではなく、延長された時間の中で**何をするか**が効果を左右します。

## 日本の小学校で取り入れるヒント

- 放課後学習は「全員一律」ではなく「つまずきのある子」に焦点を当てると効果的
- 補習の内容は個別のつまずきに対応する形にする
...
- [小学校学習指導要領解説 総則編](https://www.mext.go.jp/content/20230308-mxt_kyoiku02-100002607_001.pdf) — 「授業時数等の取扱い」と「指導方法や指導体制の工夫改善など個に応じた指導の充実」の節で、授業時数の配当と、補充的な学習などの学習活動を取り入れることが扱われています。
