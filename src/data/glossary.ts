...
export const glossary: GlossaryTerm[] = [
  ...
  { term: "グリット", en: "Grit", short: "やり抜く力(ダックワース)。近年は効果が限定的との指摘", def: "アンジェラ・ダックワースが提唱した「やり抜く力」。長期目標への情熱と粘り強さ。当初は学力との強い関連が話題になったが、Credé et al. (2018) のメタ分析(ビッグファイブ(Big Five)性格特性との重複や効果量の小ささを指摘)など近年の研究では効果が限定的で、SES等の交絡を除くと効果は小さいことが指摘されている。", category: "cognitive_science" },
