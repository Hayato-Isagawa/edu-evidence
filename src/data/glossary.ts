...
export const glossary: GlossaryTerm[] = [
  ...
  { term: "クラスターRCT", en: "Cluster RCT", short: "学級・学校単位でランダム化するRCT。教育介入に適した設計", def: "学級・学年・学校といった集団(クラスター)単位でランダム化するRCT。個人単位ではランダム化できない教育介入(学級規模縮小・教科担任制・新カリキュラム等)に適した設計。伊芸研吾氏ら(2025、RIETI ディスカッションペーパー 25-J-029)の教科担任制の効果検証もこの設計。通常のRCTより多くの対象者が必要。", category: "foundations" },
  { term: "STAR", en: "Student/Teacher Achievement Ratio (Project STAR)", short: "米国テネシー州の少人数学級クラスターRCT(1985年開始の古典)", def: "米国テネシー州で 1985 年に開始された少人数学級効果の大規模クラスターRCT。79 校 7,000 人以上の児童を、少人数学級(13〜17 人)・通常学級(22〜25 人)・補助員付通常学級(22〜25 人+教員補助)の 3 群にランダム化し、幼稚園から第 3 学年まで継続観察。Mosteller(1995, The Future of Children 5(2):113-127)が結果を整理。少人数学級が早期の学習・認知に大きな改善をもたらし、人種的少数派(マイノリティ)児童への効果は多数派児童の約 2 倍(後年は同程度)。少人数学級研究の古典的引用元。", category: "foundations" },
  ...
  { term: "GIGAスクール構想", en: "GIGA School Program", short: "児童生徒1人1台端末と高速ネットを整備する国策", def: "「すべての人にグローバルで革新的な入り口を」(Global and Innovation Gateway for All)の略。児童生徒1人1台端末と高速ネットワークを整備する日本の国策。2020年度にコロナ禍で加速的に展開。", category: "japan_context" },
  ...
  { term: "FSM", en: "Free School Meals", short: "英国の無償給食制度。受給資格は低SES児童のサブグループ指標として使われる", def: "英国の公立学校における無償給食制度(Free School Meals)。受給資格(FSM eligible)は所得・福祉受給状況により決まる。教育研究では「低SES児童」の代替指標として広く使われ、EEFのメタ分析や政府委託研究で「FSM児童」を独立サブグループとして効果量を報告する慣習がある。日本の「就学援助受給者」に概念的に近いが、運用基準は異なる。", category: "foundations" },
  ...
  { term: "PBL", en: "Project-Based Learning", short: "プロジェクト型学習。長期的・協働的に現実課題に取り組む指導法", def: "プロジェクト型学習(Project-Based Learning)。子どもが現実世界の課題に対して、調査・計画・制作・発表を長期的・協働的に進める指導法。アクティブラーニングの代表的な一形態。EEFが評価した『REALプロジェクトによる学習』(\"Learning through REAL projects\")トライアルでは、リテラシーへのポジティブな影響は確認されず、FSM受給対象児童には負の影響が示唆されている(ただし参加校の途中離脱が多く、解釈には注意が必要)。", category: "pedagogy" },
  { term: "交絡変数", en: "Confounding variable", short: "関心ある2変数の両方に影響する『隠れた第三の変数』", def: "関心のある2つの変数(例:朝食と学力)の両方に影響する、隠れた第三の変数。家庭のSESは朝食習慣と学力の双方に影響しうるため、統制しないと『朝食が学力を上げた』という誤った因果推論につながる。観察研究の最大の難所であり、RCTはランダム化により交絡を除去できる点で強力。日本疫学会の定義では(1)アウトカム(結果指標)に影響を与える、(2)要因と関連がある、(3)要因とアウトカムの中間因子(媒介変数)でない、の3条件を満たす変数を指す。", category: "methodology" },
  ...
  { term: "疑似科学", en: "Pseudoscience", short: "科学を装うが方法論を欠く主張。教育界では学習スタイル等が該当", def: "科学的根拠があるかのように主張されるが、反証可能性・体系的検証・専門家による吟味といった科学的方法を欠く言説。カール・ポパー(Karl Popper)の反証可能性(検証で誤りを示せる性質)概念や Bunge (1984) の定義「科学を装う誤り」が哲学的基盤。教育文脈では学習スタイル(VARK)、多重知能理論、心の知能指数(EQ)などが代表的批判対象で、Waterhouse (2006) や Pashler ら (2009) が実証的根拠不足を体系的に指摘している。神経神話は脳科学領域に特化した疑似科学の一種で、本概念の方が射程が広い。", category: "critical_thinking" },
  ...
  { term: "UDL", en: "Universal Design for Learning", short: "全員が分かる授業を設計する手法。視覚化・焦点化・共有化の3原則", def: "授業のユニバーサルデザイン(授業UD)。日本では桂聖氏ら(2011)が米国の教育研究組織 CAST(旧 Center for Applied Special Technology)の Universal Design for Learning を踏まえ独自に発展させた、すべての子が分かる授業設計の手法。視覚化・焦点化・共有化の3原則。", category: "pedagogy" },
  ...
  { term: "ANCOVA", en: "Analysis of Covariance", short: "共分散分析。共変量を統制してグループ間の平均差を比較する手法", def: "共分散分析(Analysis of Covariance)。分散分析(ANOVA)に連続変数の共変量(結果に影響する別の変数)を加え、その影響を統計的に統制した上でグループ間の平均差を検定する手法。教育研究のRCTでは介入前テスト得点を共変量にして介入群と対照群の事後得点を比較するのが典型で、ベースラインのばらつきを除去できるため検出力(差を検出できる確率)が高い。", category: "methodology" },
  ...
  { term: "quasi-experimental", en: "Quasi-experimental design", short: "準実験。ランダム化ができない場合の因果推論用研究デザイン", def: "準実験デザイン(Quasi-experimental design)。ランダム化が倫理的・実務的に困難な状況で因果推論を試みる研究手法群の総称。傾向スコアマッチング(似た特性の対象同士を組み合わせる手法)、差分の差分(DiD)、回帰不連続デザイン(RDD)、操作変数法(関心ある要因にだけ影響する別の変数を介して因果を推定する手法)などを含む。RCTより信頼性は劣るが、教育政策評価で現実的な選択肢として広く使われる。", category: "methodology" },
  ...
  { term: "グリット", en: "Grit", short: "やり抜く力(ダックワース)。近年は効果が限定的との指摘", def: "アンジェラ・ダックワースが提唱した「やり抜く力」。長期目標への情熱と粘り強さ。当初は学力との強い関連が話題になったが、Credé et al. (2018) のメタ分析(ビッグファイブ性格特性との重複や効果量の小ささを指摘)など近年の研究では効果が限定的で、SES等の交絡を除くと効果は小さいことが指摘されている。", category: "cognitive_science" },
  ...
  { term: "CAST", en: "CAST (originally Center for Applied Special Technology)", short: "UDLフレームを開発した米国の教育研究NPO。1984年設立、現在はCASTのみで運営", def: "米国マサチューセッツ州 Wakefield 拠点の教育研究 NPO。1984 年設立で、設立時正式名は `Center for Applied Special Technology`(現在は CAST のみで運営)。UDL(Universal Design for Learning)フレームワークの開発元として知られ、すべての学習者がアクセス可能な教育環境の設計を研究・推進している。本サイトの UDL def もこの組織の枠組みを参照している。", category: "foundations" },
  { term: "ABCD", en: "Adolescent Brain Cognitive Development Study", short: "NIH資金の米国大規模小児縦断研究。9-10歳開始11,878名21サイトで青年期まで追跡", def: "Adolescent Brain Cognitive Development Study(青年期脳・認知発達研究)。NIH(米国国立衛生研究所)が資金提供する大規模小児縦断研究で、米国 21 か所のサイトで 9〜10 歳の児童約 11,878 名をベースラインで登録、思春期から若年成人期まで追跡する。脳画像 MRI を 2 年ごと、行動評価を毎年、メンタルヘルスと物質使用に関する評価を半年ごとに実施。スクリーン時間・身体活動・睡眠・物質使用などが脳発達と認知発達に及ぼす影響を検証する世界最大級の小児神経科学コホート。", category: "foundations" },
  { term: "SEND", en: "Special Educational Needs and Disabilities", short: "英国の特別支援教育の枠組み。Children and Families Act 2014下のCode of Practice 0-25", def: "Special Educational Needs and Disabilities(特別な教育的ニーズと障害)。英国の特別支援教育の制度的枠組みで、2014 年 Children and Families Act 第 3 部で法定化された「SEND Code of Practice: 0 to 25 years」(2014 年 9 月 1 日施行)が運用基盤。0〜25 歳までの子ども・若者を対象に、地方自治体・健康機関・幼児教育施設・学校・カレッジが特別なニーズと障害を持つ子どもの教育上の責務をどう果たすかを規定している。日本の「特別支援教育」と概念的に近いが、運用基準・年齢範囲は異なる。", category: "foundations" },
  { term: "VAK", en: "Visual, Auditory, Kinesthetic", short: "視覚・聴覚・運動感覚の3チャンネルで学習者を分類するモデル(Barbe 1979)", def: "視覚(Visual)・聴覚(Auditory)・運動感覚(Kinesthetic)の頭文字。1970 年代後半に Walter Burke Barbe らが提唱した学習スタイルモデルで、神経言語プログラミング(NLP)の系譜にも位置づけられる。Fleming の VARK モデル(後年に「読み書き」を加えて 4 分類化)の前身。学習スタイル理論は Pashler ら (2009) などのレビューで「学習者の好み」と「学習成果」を結びつけるエビデンスがないと指摘されており、神経神話(疑似科学)の代表例として教員研修・通俗教育情報で繰り返し再生産される。", category: "critical_thinking" },
  { term: "VARK", en: "Visual, Auditory, Reading-writing, Kinesthetic", short: "VAKに「読み書き」を加えた4分類学習スタイル(Fleming 1987頃)。エビデンス欠如", def: "視覚(Visual)・聴覚(Auditory)・読み書き(Reading-writing)・運動感覚(Kinesthetic)の頭文字。ニュージーランドの教育者 Neil Fleming が 1987 年頃に VAK モデルに「読み書き」を加えて拡張した学習スタイル分類。学習者を 4 タイプに分け、それぞれに「最適な学習法」を提案する主張だが、Pashler et al. (2009) などのシステマティックレビューでは「学習スタイルに合わせた指導が学習成果を向上させる」エビデンスは存在しないとされる。神経神話(疑似科学)の代表例で、本サイトの神経神話・疑似科学 def 内でも参照している。", category: "critical_thinking" },
  { term: "ALT", en: "Assistant Language Teacher", short: "外国語指導助手。JETプログラム参加者の職種の一つで日本人教員とTTを行う", def: "外国語指導助手(Assistant Language Teacher)。JET プログラム(The Japan Exchange and Teaching Programme)参加者の職種の一つで、文部科学省・総務省・外務省・自治体国際化協会(CLAIR)の協力下で地方公共団体が実施する。学校(担当教員)が作成した指導計画・学習指導案に基づき、日本人外国語担当教員とのティーム・ティーチング、教材作成補助、生徒との交流活動などを担う。文部科学省が「ALT の役割」を公式に整理している。", category: "japan_context" },
  { term: "COCOLOプラン", en: "Comfortable, Customized and Optimized Locations of learning", short: "文科省2023年3月公表の不登校対策。3つの柱で学びの場を保障", def: "文部科学省が 2023 年 3 月に公表した不登校対策プラン「誰一人取り残されない学びの保障に向けた不登校対策」の通称。COCOLO は `Comfortable, Customized and Optimized Locations of learning` の頭文字。3 つの柱:(1)すべての不登校児童生徒に学びの場を保障し本人が望むときに学べるようにする、(2)チーム学校体制で児童生徒の小さな SOS を早期に察知する、(3)全ての児童生徒が安心して学べる「みんなにとって安心して学べる学校」づくり。2022 年度に小中の不登校が約 30 万人に達した状況を背景とする。", category: "japan_context" },
  { term: "EEG", en: "Electroencephalography", short: "頭皮上の電極から脳の電気活動をミリ秒単位で記録する脳波計測技術", def: "脳波計測(Electroencephalography)。頭皮上の電極から脳の電気活動をミリ秒単位で記録する非侵襲的な技術。教育・学習科学の文脈では、書字・読字・暗算などの認知課題における脳ネットワーク活動の比較研究に使われる。例えば手書きとタイピングを高密度 EEG(256 チャネル)で比較した研究(van der Weel & van der Meer, *Frontiers in Psychology*, 2024)では、手書きの方が theta(3.5〜7.5 Hz)・alpha(8〜12.5 Hz)帯域で広範な脳結合が観察され、記憶形成や情報符号化に関連すると報告されている。", category: "cognitive_science" },
];
