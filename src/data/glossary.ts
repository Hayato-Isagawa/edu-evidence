...
export const glossary: GlossaryTerm[] = [
  ...
  { term: "クラスターRCT", en: "Cluster RCT", short: "学級・学校単位でランダム化するRCT。教育介入に適した設計", def: "学級・学年・学校といった集団(クラスター)単位でランダム化するRCT。個人単位ではランダム化できない教育介入(学級規模縮小・教科担任制・新カリキュラム等)に適した設計。赤林英夫氏ら(2025)の教科担任制の効果検証もこの設計。通常のRCTより多くの対象者が必要。", category: "foundations" },
  ...
  { term: "全国学力・学習状況調査", en: "National Assessment of Academic Ability", short: "文部科学省が毎年実施する全国学力調査(小6・中3対象)", def: "文部科学省が毎年実施する学力調査。小6と中3が対象で、国語・算数(数学)・理科を測定。学力の地域差や経年変化のデータソースとして重要。", category: "japan_context" },
