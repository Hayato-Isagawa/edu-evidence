...
export const glossary: GlossaryTerm[] = [
  ...
  { term: "PBL", en: "Project-Based Learning", short: "プロジェクト型学習。長期的・協働的に現実課題に取り組む指導法", def: "プロジェクト型学習(Project-Based Learning)。子どもが現実世界の課題に対して、調査・計画・制作・発表を長期的・協働的に進める指導法。アクティブラーニングの代表的な一形態。EEF Toolkit や Hattie の Visible Learning では効果量は限定的(d ≈ 0.2 前後)とされ、効果は「教師の足場かけの質」「事前知識の有無」に強く依存する。", category: "pedagogy" },
