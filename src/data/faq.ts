      ...
      items: [
        {
          ...
          a: `EEF が原典を更新した場合や、国内で重要な研究が公表された場合に、随時見直します。明らかな誤りが見つかった場合は速やかに修正します。更新の履歴は <a href="/changelog" class="link-underline text-accent">更新履歴</a> で公開しています。各ページには、ページが根拠とする出典に最後に当たり直した日を「出典の最終確認」(コラムは「主な出典の最終確認」)として記載しています。出典のいずれかを確認した日で、すべての出典を同じ日に確認したとは限りません。`,
        },
        {
