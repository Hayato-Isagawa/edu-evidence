export interface FaqItem {
  q: string;
  /** HTML 断片。faq.astro が annotateGlossaryTerms を通して set:html で描く */
  a: string;
}
...
export function buildFaqSections(
  ...
  return [
    ...
    {
      heading: "数値を鵜呑みにしないために",
      description: "本サイトが読み手に伝えたい大切な視点",
      items: [
        {
          q: "この数値は「学力」以外の効果も含んでいますか?",
          a: `いいえ。主にテストで測定可能な学力(読解・算数等)への効果を示します。非認知能力・社会性・ウェルビーイングなど、教育にとって大切な他の側面はこの月数には反映されていません。月数の大小や、確かな数値があるかどうかとは別に、非認知面で大きな価値を持つ指導法があります(例: SEL、屋外学習、芸術活動)。EEF 自身も公式ガイドで同様の注意を示しています。`,
        },
        {
        ...
        },
        {
          ...
          a: "いいえ。数値はあくまで平均的な効果の大きさです。実際の教室では、子どもの状態・教科の特性・教師の強みによって、何が最も効くかは変わります。また、効果量の大きい指導法を機械的に重ねても、そのまま加算されるわけではありません。本サイトの情報は「選択肢を広げる」ためのものであり、「これだけやればよい」というリストではありません。",
        },
      ],
    },
    {
      heading: "使い方・応用",
      description: "実際にサイトを活用するために",
      items: [
        {
        ...
        },
        {
          ...
          a: `サイト内の項目を 5 つに分類しています。<strong>指導法</strong>(教師が明日から授業で使えるもの)、<strong>認知科学</strong>(記憶・学習の原理に基づく学習法)、<strong>制度・環境</strong>(学校や自治体レベルの政策・構造)、<strong>知っておくべき知見</strong>(現象・リスク・神話など教員が知るべき事実)、<strong>家庭・外部</strong>(保護者や学校外の要因)。トップページの絞り込みボタンで切り替えられます。`,
        },
      ],
    },
    {
      heading: "サイト運用・ライセンス",
      description: "運営方針と二次利用について",
      items: [
        {
          q: "記事の内容はどのくらいの頻度で更新されますか?",
          a: `EEF が原典を更新した場合や、国内で重要な研究が公表された場合に、随時見直します。明らかな誤りが見つかった場合は速やかに修正します。更新の履歴は <a href="/changelog" class="link-underline text-accent">更新履歴</a> で公開しています。指導法ページと、公開後に出典を確認したコラムには、ページが根拠とする出典に最後に当たり直した日を「出典の最終確認」(コラムは「主な出典の最終確認」)として記載しています。出典のいずれかを確認した日で、すべての出典を同じ日に確認したとは限りません。`,
        },
        {
          q: "このサイトの内容を授業研究や校内研修で使ってもいいですか?",
          a: "はい。本サイトは CC BY-SA 4.0 ライセンスで公開しています。出典を明記していただければ、コピー・印刷・配布・改変のいずれも自由です。校内研修の資料、授業研究のレジュメ、保護者向けのお便りなどにお使いいただけます。",
        },
        {
